...
// node_modules/@strapi/review-workflows/dist/admin/chunks/index-DcEF47R4.mjs
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-D-YCUzYy-OH4ZBGGC.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-4n0KXAeo-YUAT34D5.js");
          return {
...
//# sourceMappingURL=chunk-NGN354E2.js.map
