...
// node_modules/@strapi/content-manager/dist/admin/chunks/index-DsOgMEE-.mjs
...
var ProtectedHistoryPage = React.lazy(() => import("./History-CORGJtti-AJQASXT2.js").then((mod) => ({
...
var ProtectedPreviewPage = React.lazy(() => import("./Preview-D4L4y24d-A2QIUMED.js").then((mod) => ({
...
var ProtectedEditViewPage = (0, import_react.lazy)(() => import("./EditViewPage-CILYfIn8-QWSFI4DP.js").then((mod) => ({
  default: mod.ProtectedEditViewPage
})));
var ProtectedListViewPage = (0, import_react.lazy)(() => import("./ListViewPage-B3Frxm6y-2HHBO5OK.js").then((mod) => ({
  default: mod.ProtectedListViewPage
})));
var ProtectedListConfiguration = (0, import_react.lazy)(() => import("./ListConfigurationPage-Bgya7skT-JQCJFFWM.js").then((mod) => ({
  default: mod.ProtectedListConfiguration
})));
var ProtectedEditConfigurationPage = (0, import_react.lazy)(() => import("./EditConfigurationPage-DAbUlQVr-ANQJ37MN.js").then((mod) => ({
  default: mod.ProtectedEditConfigurationPage
})));
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(() => import("./ComponentConfigurationPage-Dtpjt9kW-NKZ4NOH3.js").then((mod) => ({
  default: mod.ProtectedComponentConfigurationPage
})));
var NoPermissions = (0, import_react.lazy)(() => import("./NoPermissionsPage-BNXoY-4Q-QKLERS6I.js").then((mod) => ({
  default: mod.NoPermissions
})));
var NoContentType = (0, import_react.lazy)(() => import("./NoContentTypePage-B2rBgAB9-L6RWBHME.js").then((mod) => ({
...
var PublishAction$1 = ({ activeTab, documentId, model, collectionType, meta, document: document2, onPreview, fromPreview = false, fromRelationModal = false }) => {
  var _a;
...
var UpdateAction = ({ activeTab, documentId, model, collectionType, onPreview, fromPreview = false, fromRelationModal = false }) => {
  ...
  const { formatMessage } = useIntl();
  const { create: create8, update, clone, isLoading } = useDocumentActions(fromPreview, fromRelationModal);
  const [{ query, rawQuery }] = useQueryParams();
  const params = React.useMemo(() => buildValidParams(query), [
    query
  ]);
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en-C2zEwS3--FQWOY2A5.js");
    ...
    case "./translations/zh-Hans.json":
      return import("./zh-Hans-DEAhqI3x-LUPME43B.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-C8AQHDvk-Y6Y5MA7C.js");
        return {
          Component: Layout
        };
      },
...
prismjs/prism.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YNVLQLYH.js.map
