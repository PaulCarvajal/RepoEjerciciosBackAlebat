...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index--9k1GyI3.mjs';
import { b as useNotification, e as useAPIErrorHandler, c as useTypedSelector, P as Page, k as useRBAC } from './Theme--MyHNY5P.mjs';
import { u as useEnterprise } from './useEnterprise-Dy8wMNV5.mjs';
import { g as getDisplayName } from './users-B3iOAYG-.mjs';
import * as yup from 'yup';
import { i as isBaseQueryError } from './admin-CzAa-bgU.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-C4woUMLW.mjs';
...
import './useAdminRoles-C1u-iAFU.mjs';
...
const ModalForm = ({ onToggle })=>{
    ...
    const MagicLink = useEnterprise(MagicLinkCE, async ()=>(await import('./MagicLinkEE-CK50hF_W.mjs')).MagicLinkEE);
 ...
 * -----------------------------------------------------------------------------------------------*/ const ListPageCE = ()=>{
    ...
    const CreateAction = useEnterprise(CreateActionCE, async ()=>(await import('./CreateActionEE-DZJZ2PI-.mjs')).CreateActionEE);
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await import('./ListPage-D8sJ2CDr.mjs')).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-D142eDtf.mjs.map
