...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index--9k1GyI3.mjs';
import { a as useAuth, p as useAppInfo, q as useStrapiApp, d as useTracking, P as Page } from './Theme--MyHNY5P.mjs';
...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React.useMemo(()=>SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async ()=>(await import('./index--9k1GyI3.mjs').then(function (n) { return n.O; })).SETTINGS_LINKS_EE(), {
...
export { Layout };
//# sourceMappingURL=Layout-g628ELIy.mjs.map
