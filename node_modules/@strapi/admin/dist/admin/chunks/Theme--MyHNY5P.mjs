...
import { s as setCookie, e as deleteCookie, g as getCookieValue, a as adminApi, f as useInitQuery, h as useTelemetryPropertiesQuery, j as useProjectSettingsQuery, k as useUpdateProjectSettingsMutation } from './admin-CzAa-bgU.mjs';
...
const getStoredToken = ()=>{
    const token = localStorage.getItem(STORAGE_KEYS$1.TOKEN) ?? getCookieValue(STORAGE_KEYS$1.TOKEN);
...
const adminSlice = createSlice({
    ...
    reducers: {
        ...
        login (state, action) {
            ...
            if (!persist) {
                setCookie(STORAGE_KEYS$1.TOKEN, JSON.stringify(token));
            } else {
...
export { AuthProvider as A, TrackingProvider as B, ConfigurationContextProvider as C, ConfigurationProvider as D, LANGUAGE_LOCAL_STORAGE_KEY as E, getIn as F, GuidedTourProvider as G, setIn as H, setLocale as I, useForgotPasswordMutation as J, getByteSize as K, LanguageProvider as L, useGetRegistrationInfoQuery as M, NotificationsProvider as N, useRegisterAdminMutation as O, Page as P, useRegisterUserMutation as Q, RBAC as R, StrapiAppProvider as S, Theme as T, useResetPasswordMutation as U, logout as V, THEME_LOCAL_STORAGE_KEY as W, useTypedStore as X, useAuth as a, useNotification as b, useTypedSelector as c, useTracking as d, useAPIErrorHandler as e, useUpdateMeMutation as f, useIsSSOLockedQuery as g, createTypedSelector as h, useGetProviderOptionsQuery as i, useUpdateProviderOptionsMutation as j, useRBAC as k, login as l, useGetProvidersQuery as m, useGuidedTour as n, useQueryParams as o, useAppInfo as p, useStrapiApp as q, getStoredToken as r, setAppTheme as s, reducer$1 as t, useTypedDispatch as u, AppInfoProvider as v, useConfiguration as w, capitalise as x, isObject as y, createContext as z };
//# sourceMappingURL=Theme--MyHNY5P.mjs.map
