 ...
 * -----------------------------------------------------------------------------------------------*/ const ApplicationInfoPage = ()=>{
    ...
    const AdminSeatInfo = useEnterprise.useEnterprise(AdminSeatInfoCE, async ()=>(await Promise.resolve().then(function () { return require('./AdminSeatInfo-VyMQjnJ1.js'); })).AdminSeatInfoEE);
...
//# sourceMappingURL=ApplicationInfoPage-kDFILBj-.js.map
