...
import { z as createContext, S as StrapiAppProvider, A as AuthProvider, L as LanguageProvider, T as Theme, N as NotificationsProvider, B as TrackingProvider, G as GuidedTourProvider, D as ConfigurationProvider, E as LANGUAGE_LOCAL_STORAGE_KEY, P as Page, F as getIn, H as setIn, w as useConfiguration, c as useTypedSelector, u as useTypedDispatch, I as setLocale, a as useAuth, e as useAPIErrorHandler, J as useForgotPasswordMutation, b as useNotification, p as useAppInfo, K as getByteSize, d as useTracking, n as useGuidedTour, M as useGetRegistrationInfoQuery, O as useRegisterAdminMutation, Q as useRegisterUserMutation, l as login, U as useResetPasswordMutation, t as reducer$2, V as logout, W as THEME_LOCAL_STORAGE_KEY, r as getStoredToken, R as RBAC, o as useQueryParams, X as useTypedStore } from './Theme--MyHNY5P.mjs';
...
import { i as isBaseQueryError, f as useInitQuery, a as adminApi, l as createAbsoluteUrl, m as getFetchClient } from './admin-CzAa-bgU.mjs';
 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await import('./AuthResponse-BePnIBXF.mjs');
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await import('./ListPage-qmeP5jOI.mjs');
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await import('./SingleSignOnPage-YPr4xe45.mjs');
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise(Login, async ()=>(await import('./Login-bu1h9E8X.mjs')).LoginEE);
    const forms = useEnterprise(FORMS, async ()=>(await import('./constants-BCKzqdXx.mjs')).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-kTskK8Pt.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-DsQaz-fc.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-VKEydocT.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-D142eDtf.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-BekHBuFo.mjs');
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-DFb-DikZ.mjs');
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const editWebhook = await import('./EditPage-Djyfbl4T.mjs').then(function (n) { return n.b; });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-DjrhoFw0.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-D6LNVXVA.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-8QpHTUbU.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditViewPage-ClmZ5cZJ.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-CRBCC3nt.mjs');
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-C1Z-uAQ0.mjs');
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditView-DU8CdAiB.mjs');
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-C2u_F-CT.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-VAiQNvSu.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-LwIFccM6.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await import('./PurchaseContentHistory-BTCweTGw.mjs');
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await import('./UseCasePage-BXZo4s2b.mjs');
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await import('./HomePage-BSxnSe97.mjs');
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await import('./ProfilePage-CVGsfsET.mjs');
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await import('./MarketplacePage-4KESRPsD.mjs');
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await import('./Layout-g628ELIy.mjs');
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await import('./ApplicationInfoPage-BMzTmxNz.mjs');
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await import('./AuthenticatedLayout-CHHvHDJC.mjs');
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case './translations/ar.json': return import('./ar-AcbIy3_Y.mjs');
    ...
    case './translations/en.json': return import('./en-DSFp6NdB.mjs');
    case './translations/es.json': return import('./es-DlUN520X.mjs');
    case './translations/eu.json': return import('./eu-BjPzWjP-.mjs');
    case './translations/fr.json': return import('./fr-CQLsibRy.mjs');
    ...
    case './translations/ru.json': return import('./ru-BJXvVcrN.mjs');
    ...
    case './translations/uk.json': return import('./uk-C49OgQut.mjs');
    case './translations/vi.json': return import('./vi-r6WrFGyI.mjs');
    case './translations/zh-Hans.json': return import('./zh-Hans-Btm28zHr.mjs');
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return import('./en-GB-Bff62574.mjs');
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
...
//# sourceMappingURL=index--9k1GyI3.mjs.map
