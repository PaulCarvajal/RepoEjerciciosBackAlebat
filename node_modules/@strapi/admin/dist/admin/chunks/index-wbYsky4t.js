...
var Theme = require('./Theme-BHq8yfk4.js');
...
var admin = require('./admin-CyNajRlE.js');
 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await Promise.resolve().then(function () { return require('./AuthResponse-DZ1z52rQ.js'); });
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-C5k9RCEl.js'); });
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await Promise.resolve().then(function () { return require('./SingleSignOnPage-CjxuMPV9.js'); });
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise.useEnterprise(Login, async ()=>(await Promise.resolve().then(function () { return require('./Login-CRYSRxow.js'); })).LoginEE);
    const forms = useEnterprise.useEnterprise(FORMS, async ()=>(await Promise.resolve().then(function () { return require('./constants-v92J3XKA.js'); })).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-Bfne_O3J.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-CxaJ8qvH.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-DPAPWw5y.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-CD_LPps8.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-DUgHNTrC.js'); });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-e74MeRIh.js'); });
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const editWebhook = await Promise.resolve().then(function () { return require('./EditPage-DcaJLTf1.js'); }).then(function (n) { return n.EditPage$1; });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-6COrRs74.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-B0OF_QKQ.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-DqrI9h9T.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditViewPage-DFGRtbdO.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-B4lW9A3B.js'); });
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-BtNxHO8z.js'); });
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditView-C14GW9gW.js'); });
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await Promise.resolve().then(function () { return require('./InstalledPlugins-D79vB6Ew.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await Promise.resolve().then(function () { return require('./PurchaseAuditLogs-DvJjisAq.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await Promise.resolve().then(function () { return require('./PurchaseSingleSignOn-BYAovZ--.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await Promise.resolve().then(function () { return require('./PurchaseContentHistory-BRiWs6dm.js'); });
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await Promise.resolve().then(function () { return require('./UseCasePage-DPm1H4bh.js'); });
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await Promise.resolve().then(function () { return require('./HomePage-Bw1ORQzf.js'); });
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await Promise.resolve().then(function () { return require('./ProfilePage-CWIYDVzZ.js'); });
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await Promise.resolve().then(function () { return require('./MarketplacePage-CYnKcyfZ.js'); });
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await Promise.resolve().then(function () { return require('./Layout-DnqC5VlY.js'); });
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await Promise.resolve().then(function () { return require('./ApplicationInfoPage-kDFILBj-.js'); });
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await Promise.resolve().then(function () { return require('./AuthenticatedLayout-Cql6WSOa.js'); });
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case './translations/ar.json': return Promise.resolve().then(function () { return require('./ar-BDWhknhD.js'); });
    ...
    case './translations/en.json': return Promise.resolve().then(function () { return require('./en-CNKn2Jdp.js'); });
    ...
    case './translations/fr.json': return Promise.resolve().then(function () { return require('./fr-aC2SXOJP.js'); });
    ...
    case './translations/ru.json': return Promise.resolve().then(function () { return require('./ru-BcqT3DAj.js'); });
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-CaCmMqlb.js'); });
    case './translations/vi.json': return Promise.resolve().then(function () { return require('./vi-BsRo_l_e.js'); });
    case './translations/zh-Hans.json': return Promise.resolve().then(function () { return require('./zh-Hans-BPwvjdpO.js'); });
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return Promise.resolve().then(function () { return require('./en-GB-BlQqz9it.js'); });
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
...
//# sourceMappingURL=index-wbYsky4t.js.map
