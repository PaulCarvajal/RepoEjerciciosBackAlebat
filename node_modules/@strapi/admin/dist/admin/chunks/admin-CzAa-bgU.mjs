...
const getToken = ()=>JSON.parse(localStorage.getItem(STORAGE_KEYS.TOKEN) ?? getCookieValue(STORAGE_KEYS.TOKEN) ?? '""');
/**
 * @public
...
export { FetchError as F, adminApi as a, useGetPluginsQuery as b, isFetchError as c, useInformationQuery as d, deleteCookie as e, useInitQuery as f, getCookieValue as g, useTelemetryPropertiesQuery as h, isBaseQueryError as i, useProjectSettingsQuery as j, useUpdateProjectSettingsMutation as k, createAbsoluteUrl as l, getFetchClient as m, fetchBaseQuery as n, setCookie as s, useGetLicenseLimitsQuery as u };
//# sourceMappingURL=admin-CzAa-bgU.mjs.map
