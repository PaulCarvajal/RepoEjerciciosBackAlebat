...
const getStoredToken = ()=>{
    const token = localStorage.getItem(STORAGE_KEYS$1.TOKEN) ?? admin.getCookieValue(STORAGE_KEYS$1.TOKEN);
...
const adminSlice = toolkit.createSlice({
    ...
    reducers: {
        ...
        login (state, action) {
            ...
            if (!persist) {
                admin.setCookie(STORAGE_KEYS$1.TOKEN, JSON.stringify(token));
            } else {
        ...
        logout (state) {
            state.token = null;
            admin.deleteCookie(STORAGE_KEYS$1.TOKEN);
...
//# sourceMappingURL=Theme-BHq8yfk4.js.map
