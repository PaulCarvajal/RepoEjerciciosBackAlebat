...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-Cfm1dM3v.js'); });
...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-BBHvDTKY.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-5TS6R8ax.js'); });
                return {
...
//# sourceMappingURL=index-mrIASzro.js.map
