...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return import('./uk-DPZD6U8g.mjs');
...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>import('./App-DOvEuP1h.mjs').then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await import('./SettingsPage-B7xS0X0V.mjs');
                return {
...
//# sourceMappingURL=index-zOCLhXyV.mjs.map
